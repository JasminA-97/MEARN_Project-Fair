    ...
    <Container>
      ...
      </Navbar.Brand>
      {
        ...
        <div className="ms-auto">
          <button onClick={handleLogout} style={{textDecoration:'none'}} className="btn btn-link fw-bolder">Logout<i className="fa-solid fa-right-from-bracket ms-1"></i></button>
        </div>
      }
    </Container>
    </Navbar>
